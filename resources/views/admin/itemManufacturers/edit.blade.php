...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.itemManufacturer.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.item-manufacturers.update", [$itemManufacturer->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="name">{{ trans('cruds.itemManufacturer.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $itemManufacturer->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contactinfo') ? 'is-invalid' : '' }}" type="text" name="contactinfo" id="contactinfo" value="{{ old('contactinfo', $itemManufacturer->contactinfo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('address') ? 'is-invalid' : '' }}" type="text" name="address" id="address" value="{{ old('address', $itemManufacturer->address) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('sales_contact_info') ? 'is-invalid' : '' }}" type="email" name="sales_contact_info" id="sales_contact_info" value="{{ old('sales_contact_info', $itemManufacturer->sales_contact_info) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tech_support_contact_info') ? 'is-invalid' : '' }}" type="email" name="tech_support_contact_info" id="tech_support_contact_info" value="{{ old('tech_support_contact_info', $itemManufacturer->tech_support_contact_info) }}">
